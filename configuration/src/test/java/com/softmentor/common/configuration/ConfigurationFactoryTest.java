...
public class ConfigurationFactoryTest
{
    ...
    private final ConfigurationFactory<Example> factory   = new ConfigurationFactory<>(Example.class, validator,
    ...
    public void throwsAnExceptionOnMalformedFiles() throws Exception
    {
        ...
        {
            assertThat(e.getMessage()).containsOnlyOnce(" * Failed to parse configuration; Can not instantiate");
        }
    }
        ...
        catch (ConfigurationValidationException e)
        {
            if ("en".equals(Locale.getDefault().getLanguage()))
            {
                assertThat(e.getMessage()).endsWith(
                    String.format("factory-test-invalid.yml has an error:%n"
