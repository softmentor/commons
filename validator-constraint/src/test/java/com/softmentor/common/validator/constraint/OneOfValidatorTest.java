...
import static com.softmentor.common.validator.constraint.ConstraintViolations.format;
...
public class OneOfValidatorTest
{
    ...
    public static class Example
    {
        ...
        @OneOf(value =
        { "one", "two", "three" }, ignoreCase = true)
        private String caseInsensitive       = "one";

        @OneOf(value =
        { "one", "two", "three" }, ignoreWhitespace = true)
    ...
    public void doesNotAllowOtherElements() throws Exception
    {
        ...
        assertThat(format(validator.validate(example))).containsOnly(
            "basic must be one of [one, two, three] (was four)");
    }
