...
public class PortRangeValidatorTest
{
    ...
    public void rejectsNegativePorts() throws Exception
    {
        ...
        assertThat(ConstraintViolations.format(validator.validate(example))).containsOnly(
            "port must be between 1 and 65535 (was -1)");
    }
    ...
    public void allowsForCustomMinimumPorts() throws Exception
    {
        ...
        assertThat(ConstraintViolations.format(validator.validate(example))).containsOnly(
            "otherPort must be between 10000 and 15000 (was 8080)");
    }
    ...
    public void allowsForCustomMaximumPorts() throws Exception
    {
        ...
        assertThat(ConstraintViolations.format(validator.validate(example))).containsOnly(
            "otherPort must be between 10000 and 15000 (was 16000)");
    }
}
